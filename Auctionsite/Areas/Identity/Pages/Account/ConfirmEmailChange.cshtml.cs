...
namespace Auctionsite.Areas.Identity.Pages.Account
{
    public class ConfirmEmailChangeModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string email, string code)
        {
            ...
            if (!result.Succeeded)
            {
                StatusMessage = "Byte av e-postadress misslyckades.";
                return Page();
            }
            ...
            {
                StatusMessage = "Byte av användarnamn misslyckades.";
                return Page();
            }

            await _signInManager.RefreshSignInAsync(user);
            StatusMessage = "Tack för att du bekräftat ditt byte av e-postadress.";
            return Page();
        }
    }
}
