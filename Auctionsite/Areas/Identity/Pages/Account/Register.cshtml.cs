...
namespace Auctionsite.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage = "Var god fyll i ett lösenord.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                if (!AgeVerificationHelper.VerifyAge(Input.Dob.Value))
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(
                        ...
                        $"Hej och välkommen till marknadsplatsen Auctionsite! </br></br>Vänligen verifiera din e-post genom att <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>klicka här</a>. </br></br>Har du inte skapat ett konto hos Auctionsite, kan du ignorera detta mejl.");
        ...
        public async Task<IActionResult> OnPostBackAsync(string returnUrl = null)
        {
            ReturnUrl = returnUrl ?? Url.Content("~/");
